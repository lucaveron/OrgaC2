...
cantidad_total_de_elementos:
	...
	xor rax, rax
	mov rdi, [rdi] ; Muevo a rdi la posicion apuntada por el puntero, obtenemos el puntero al nodo head.

.loop:
	add rax, [rdi + LONGITUD_OFFSET] ; Al acceder a la direccion de memoria del nodo head sumado el offset obtenemos la longitud
	mov rdi, [rdi] ; Actualizo rdi entrando el nodo next, que es el primer elemento de cada nodo.
	cmp rdi, 0 ; Chequeamos si el next es null. En ese caso, dejamos de iterar porque terminamos de recorrer la lista.
	jne .loop
